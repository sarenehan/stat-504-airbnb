...
df.var <- read.table('/Users/stewart/projects/stat-504-airbnb/data/variables.csv',header=TRUE,sep=',');
df.data <- read.csv('/Users/stewart/projects/stat-504-airbnb/data/listings.csv',header=TRUE);
```
